...
exports.useCompetitorAnalysis = useCompetitorAnalysis;
var react_1 = require("react");
var tool_registry_1 = require("../lib/tools/tool-registry");
function useCompetitorAnalysis() {
    var _this = this;
    var _a = (0, react_1.useState)(false), isLoading = _a[0], setIsLoading = _a[1];
    var _b = (0, react_1.useState)(''), report = _b[0], setReport = _b[1];
    var _c = (0, react_1.useState)([]), competitors = _c[0], setCompetitors = _c[1];
    var _d = (0, react_1.useState)([]), insights = _d[0], setInsights = _d[1];
    var _e = (0, react_1.useState)({}), metrics = _e[0], setMetrics = _e[1];
    var analyze = function (params) { return __awaiter(_this, void 0, void 0, function () {
        var result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, tool_registry_1.toolRegistry.executeTool('analyze-competitors', params)];
                case 2:
                    result = _a.sent();
