...
var ToolManager = /** @class */ (function () {
    function ToolManager() {
        this.tools = new Map();
        this.webSearch = new web_search_1.WebSearch();
        ...
        this.register({
            ...
            execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    ...
                    return [2 /*return*/, this.webSearch.search(query)];
                });
            }); }
        });
        this.register({
            ...
            execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    ...
                    return [2 /*return*/, this.webSearch.fetchContent(url)];
                });
            }); }
        });
        this.register({
            ...
            execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    ...
                    return [2 /*return*/, memory_1.memoryManager.search(query)];
                });
            }); }
        });
    };
    ...
    ToolManager.prototype.execute = function (name, args) {
    ...
    ToolManager.prototype.getTools = function () {
        return Array.from(this.tools.values());
    };
    return ToolManager;
}());
exports.tools = new ToolManager();
