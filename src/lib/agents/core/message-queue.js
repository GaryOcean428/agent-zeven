...
var MessageQueue = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!this.processing) return [3 /*break*/, 2];
    ...
    MessageQueue.prototype.registerHandler = function (type, handler) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(this.queue.length > 0)) return [3 /*break*/, 5];
    ...
    MessageQueue.prototype.getQueueLength = function () {
