...
var VectorStore = /** @class */ (function () {
    ...
    VectorStore.prototype.addEntry = function (content, type, metadata) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new AppError_1.AppError('Failed to add vector entry', 'VECTOR_STORE_ERROR', error_1);
    ...
    VectorStore.prototype.search = function (query_1) {
        return __awaiter(this, arguments, void 0, function (query, limit) {
            var queryEmbedding_1, results, error_2;
            var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        results = this.entries.map(function (entry) { return ({
                            content: entry.content,
                            score: _this.cosineSimilarity(queryEmbedding_1, entry.embedding)
                        }); });
                    ...
                    case 2:
                        error_2 = _a.sent();
                        throw new AppError_1.AppError('Failed to search vector store', 'VECTOR_STORE_ERROR', error_2);
                    case 3: return [2 /*return*/];
                }
            });
        });
